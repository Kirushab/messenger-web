-- 075: Fix "column reference 'game_id' is ambiguous" in alias_create_game.
-- Локальная PL/pgSQL переменная называлась game_id и конфликтовала с
-- alias_teams.game_id в INSERT INTO ... VALUES (game_id, ...).
-- Переименовываем в v_game_id.
